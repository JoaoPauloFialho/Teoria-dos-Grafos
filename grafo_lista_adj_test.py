...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_dij_tree = MeuGrafo()
        self.g_dij_tree.adiciona_vertice("A")
        self.g_dij_tree.adiciona_vertice("B")
        self.g_dij_tree.adiciona_vertice("C")
        self.g_dij_tree.adiciona_vertice("D")
        self.g_dij_tree.adiciona_vertice("E")
        self.g_dij_tree.adiciona_vertice("F")
        self.g_dij_tree.adiciona_aresta("a1", 'A', 'B', 2)
        self.g_dij_tree.adiciona_aresta("a3", 'B', 'D', 1)
        self.g_dij_tree.adiciona_aresta("a8", 'D', 'F', 1)
        self.g_dij_tree.adiciona_aresta("a4", 'B', 'C', 2)
        self.g_dij_tree.adiciona_aresta("a7", 'C', 'E', 3)
        ...
        self.g_tp_tree = MeuGrafo()
        self.g_tp_tree.adiciona_vertice("A")
        self.g_tp_tree.adiciona_vertice("B")
        self.g_tp_tree.adiciona_vertice("C")
        self.g_tp_tree.adiciona_vertice("D")
        self.g_tp_tree.adiciona_aresta('a1', 'A', 'B', 1)
        self.g_tp_tree.adiciona_aresta('a2', 'B', 'C', 5)
        self.g_tp_tree.adiciona_aresta('a5', 'D', 'C', 5)
        ...
        self.dijkstra5_tree = MeuGrafo()
        self.dijkstra5_tree.adiciona_vertice("A")
        self.dijkstra5_tree.adiciona_vertice("B")
        self.dijkstra5_tree.adiciona_vertice("C")
        self.dijkstra5_tree.adiciona_aresta('a2', 'A', 'C', 1)
        self.dijkstra5_tree.adiciona_aresta('a3', 'C', 'B', 1)
        ...
        self.g_jp = MeuGrafo()
        self.g_jp.adiciona_vertice("AX")
        self.g_jp.adiciona_vertice("BX")
        self.g_jp.adiciona_vertice("XA")
        self.g_jp.adiciona_vertice("XB")
        self.g_jp.adiciona_aresta("u1", "AX", "BX", 7)
        self.g_jp.adiciona_aresta("u2", "AX", "XA", 5)
        self.g_jp.adiciona_aresta("u3", "AX", "XB", 2)
        self.g_jp.adiciona_aresta("u4", "XB", "XA", 1)
        self.g_jp.adiciona_aresta("u5", "XB", "BX", 3)
        self.g_jp.adiciona_aresta("u6", "BX", "AX", 4)

        self.g_jp_tree = MeuGrafo()
        self.g_jp_tree.adiciona_vertice("AX")
        self.g_jp_tree.adiciona_vertice("XB")
        self.g_jp_tree.adiciona_vertice("XA")
        self.g_jp_tree.adiciona_vertice("BX")
        self.g_jp_tree.adiciona_aresta('u3', 'AX', 'XB', 2)
        self.g_jp_tree.adiciona_aresta('u4', 'XB', 'XA', 1)
        self.g_jp_tree.adiciona_aresta('u5', 'XB', 'BX', 3)
    ...
    def testPrim(self):
        self.assertEqual(self.g_tp.prim(), self.g_tp_tree)
        self.assertEqual(self.g_dij.prim(), self.g_dij_tree)
        self.assertEqual(self.dijkstra5.prim(), self.dijkstra5_tree)
        self.assertEqual(self.g_jp.prim(), self.g_jp_tree)


    def test_kruskall(self):
        self.assertEqual(self.g_jp.kruskall(), self.g_jp_tree)
        self.assertEqual(self.g_tp.kruskall(), self.g_tp_tree)
        self.assertEqual(self.g_dij.kruskall(), self.g_dij_tree)
        self.assertEqual(self.dijkstra5.kruskall(), self.dijkstra5_tree)
