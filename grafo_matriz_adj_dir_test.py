...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #self.fisica.adiciona_aresta("a28","Física Moderna","Física Moderna")
        self.fisica.adiciona_aresta("a29","Física Básica IV","Física Moderna Experimental")
        self.fisica.adiciona_aresta("a30","Física Experimental IV","Física Moderna Experimental")
        self.fisica.adiciona_aresta("a31","Física Básica I","Mecânica Analítica")
        self.fisica.adiciona_aresta("a32","Física Matemática I","Mecânica Analítica")
        self.fisica.adiciona_aresta("a33","Física Básica IV","Evolução do Pensamento Científico")
        self.fisica.adiciona_aresta("a34","Prática de Ensino I","Prática de Ensino II")
        self.fisica.adiciona_aresta("a35","Física Básica II","Estágio Supervisionado II")
        self.fisica.adiciona_aresta("a36","Estágio Supervisionado I","Estágio Supervisionado II")
        self.fisica.adiciona_aresta("a37","Física Moderna","Mecânica Quântica")
        self.fisica.adiciona_aresta("a38","Física Básica III","Eletromagnetismo")
        self.fisica.adiciona_aresta("a39","Cálculo Diferencial e Integral III","Eletromagnetismo")
        self.fisica.adiciona_aresta("a40","Prática de Ensino II","Prática de Ensino III")
        self.fisica.adiciona_aresta("a41","Física Básica II","Prática de Lab. e Inst. para o Ens. de Fís. I")
        self.fisica.adiciona_aresta("a42","Didática Geral","Prática de Lab. e Inst. para o Ens. de Fís. I")
        self.fisica.adiciona_aresta("a43","Física Básica III","Estágio Supervisionado III")
        self.fisica.adiciona_aresta("a44","Estágio Supervisionado II","Estágio Supervisionado III")
        self.fisica.adiciona_aresta("a45","Educação em Diversidade","Libras")
        self.fisica.adiciona_aresta("a46","Prática de Lab. e Inst. para o Ens. de Fís. I","Prática de Lab. e Inst. para o Ens. de Fís. II")
        self.fisica.adiciona_aresta("a47","Prática de Ensino III","Prática de Ensino IV")
        self.fisica.adiciona_aresta("a48","Termodinâmica","Mecânica Estatística")
        self.fisica.adiciona_aresta("a49","Mecânica Quântica","Mecânica Estatística")
        self.fisica.adiciona_aresta("a50","Metodologia do Trabalho Científico","TCC")
        self.fisica.adiciona_aresta("a51","Língua Portuguesa II","TCC")
        self.fisica.adiciona_aresta("a52","Física Básica IV","Estágio Supervisionado IV")
        self.fisica.adiciona_aresta("a53","Estágio Supervisionado III","Estágio Supervisionado IV")
        ...
        self.matematica.adiciona_aresta("a8","Matemática para o Ensino Fundamental","Prática de Laboratório de Ensino de Matemática 1")
        ...
        self.matematica.adiciona_aresta("a14","Prática de Laboratório de Ensino de Matemática 1","Prática de Laboratório de Ensino de Matemática 2")
        ...
        self.matematica.adiciona_aresta("a19","Prática de Laboratório de Ensino de Matemática 2","Prática de Ensino de Matemática 1")
        self.matematica.adiciona_aresta("a20","Prática de Laboratório de Ensino de Matemática 2","Introdução à Programação")
        self.matematica.adiciona_aresta("a21","Prática de Laboratório de Ensino de Matemática 2","Estágio Supervisionado 1")
        ...
        self.matematica.adiciona_aresta("a26","Metodologia do Trabalho Científico","Pesquisa Aplicada em Matemática 1")
        ...
        self.letras.adiciona_aresta("a18","Seminário de Pesquisa Interdisciplinar I","Seminário de Pesquisa Interdisciplinar II")
        ...
        self.letras.adiciona_aresta("a25","Seminário de Pesquisa Interdisciplinar I","Seminário de Pesquisa Interdisciplinar III")
        ...
        self.letras.adiciona_aresta("a29","Orientação de Estágio Supervisionado I","Orientação de Estágio Supervisionado II")
        self.letras.adiciona_aresta("a30","Seminário de Pesquisa Interdisciplinar I","Seminário de Pesquisa Interdisciplinar IV")
        ...
        self.letras.adiciona_aresta("a35","Orientação de Estágio Supervisionado II","Orientação de Estágio Supervisionado III")
        ...
        self.letras.adiciona_aresta("a42","Língua Brasileira de Sinais (LIBRAS)","Língua Portuguesa como segunda língua para surdos (Optativa)")
        self.letras.adiciona_aresta("a43","História da Educação Brasileira","Sociologia da Educação")
        self.letras.adiciona_aresta("a44","Orientação de Estágio Supervisionado III","Orientação de Estágio Supervisionado IV")
        ...
        self.telematica.adiciona_aresta("a19","Estatística Aplicada à Telemática","Teoria da Informação e Codificação")
        ...
        self.telematica.adiciona_aresta("a36","Metodologia da Pesquisa Científica","Estágio Supervisionado (Optativa)")
    ...
    def test_khan(self):
        engenharia_computacao = ['Pré-Cálculo', 'Inglês Instrumental', 'Introdução à Engenharia de Computação', 'Algoritmos e Programação', 'Lab. de Algoritmos e Programação', 'Sistemas Digitais I', 'Medição Eletro-eletrônica', 'Estatística Aplicada à Computação', 'Leitura e Produção de Textos', 'Educação Ambiental e Sustentabilidade', 'Relações Humanas no Trabalho', 'Metodologia da Pesquisa Científica', 'Libras', 'Desenho Assistido por Computador', 'Empreendedorismo de Base Tecnológica', 'Educação em Direitos Humanos', 'Educação em Diversidade', 'Cálculo I', 'Estruturas de Dados e Algoritmos', 'Laboratório de Estruturas de Dados e Algoritmos', 'Sistemas Digitais II', 'Programação Orientada a Objetos', 'Laboratório de Programação Orientada a Objetos', 'Técnicas de Prototipagem', 'Cálculo II', 'Teoria dos Grafos', 'Organização e Arquitetura de Computadores', 'Física Clássica', 'Teoria da Computação', 'Redes de Computadore', 'Bancos de Dados', 'Padrões de Projetos', 'Análise e Técnicas de Algoritmos', 'Projeto em Engenharia de Computação I', 'Sistemas Operacionais', 'Microprocessadores e Microcontroladores', 'Álgebra Linear Aplicada à Computação', 'Eletricidade e Eletromagnetismo', 'Inteligência Artificial', 'Sinais e Sistemas', 'Análise e Projeto de Sistemas', 'Teste de Software', 'Projeto em Engenharia de Computação II', 'Projeto de Sistemas Digitais', 'Métodos Numéricos', 'Circuitos Eletro-Eletrônicos', 'Gerência de Projetos', 'Sistemas Embarcados', 'Verificação Funcional de Sistemas Digitais', 'Processamento Digital de Sinais', 'Sensores e Atuadores', 'Controle e Automação I']
        letras = ['Introdução aos Estudos Literários', 'Introdução à Linguistica', 'Leitura e Produção de Texto I', 'Informática Básica', 'Fundamentos da Educação a Distância', 'Inglês Instrumental', 'História da Educação Brasileira', 'Fundamentos da Linguística Românica', 'Metodologia da Pesquisa Científica', 'Psicologia da Aprendizagem', 'Seminário de Pesquisa Interdisciplinar I', 'Didática', 'Língua Brasileira de Sinais (LIBRAS)', 'Educação Inclusiva', 'Gestão Educacional', 'Tópicos em Projetos Especiais', 'Educação e Direitos Humanos', 'Educação Ambiental e Interdisciplinaridade', 'Teoria Literária I', 'Literatura e Ensino', 'Morfologia da Língua Portuguesa', 'Linguística I', 'Filosofia da Educação', 'História da Língua Portuguesa', 'Seminário de Pesquisa Interdisciplinar II', 'Leitura e Produção de Texto II', 'Orientação de Estágio Supervisionado I', 'Seminário de Pesquisa Interdisciplinar III', 'Seminário de Pesquisa Interdisciplinar IV', 'Estrutura e Funcionamento da Educ. Básica', 'Língua Portuguesa como segunda língua para surdos (Optativa)', 'Sociologia da Educação', 'Teoria Literária II', 'Literatura Brasileira I', 'Literatura Portuguesa I', 'Linguística II', 'Fonética e Fonologia da Língua Portuguesa', 'Aquisição da Linguagem', 'Metodologia do Ensino de Literatura', 'Orientação de Estágio Supervisionado II', 'Estágio Supervisionado I', 'Orientação de TCC I', 'Literatura Brasileira II', 'Literatura Portuguesa II', 'Morfossintaxe', 'Literatura Brasileira III', 'Semântica da Lingua Portuguesa', 'Metodologia do Ensino de Língua Portuguesa', 'Literatura Brasileira IV', 'Literaturas Africanas de Língua Portuguesa', 'Sociolinguística', 'Literatura Brasileira V', 'Literatura Infantil e juvenil', 'Literatura e Cultura Popular', 'Orientação de Estágio Supervisionado III', 'Pragmática', 'Estágio Supervisionado II', 'Orientação de TCC II', 'Orientação de Estágio Supervisionado IV', 'Estágio Supervisionado III']
        construcao_edf = ['Informática Básica', 'Inglês Instrumental', 'Português Instrumental', 'Química Aplicada', 'Cálculo Diferencial e Integral I', 'Álgebra Vetorial e Geometria Analítica', 'Desenho Técnico', 'Introdução a Construção Edifícios', 'Metodologia da Pesquisa Científica', 'Matemática Financeira Aplicada', 'Instalações Especiais', 'Formação do Empreendedor', 'Legislação Aplicada', 'Relações Humanas no Trabalho', 'Trabalho de Conclusão de Curso', 'Estágio Supervisionado', 'Libras (optativa)', 'Física I', 'Materiais de Construção I', 'Des. Assist. por Computador I', 'Cálculo Diferencial e Integral II', 'Topografia I', 'Desenho e Projeto Arquitetônico', 'Estatística Aplicada', 'Gestão Ambiental', 'Administração de Custos', 'Resistência dos Materiais', 'Física II', 'Técnicas Construtivas I', 'Topografia II', 'Materiais de Construção II', 'Des. Assist. por Computador II', 'Instalações Hidrossanitárias', 'Instalações Elétricas Pred.', 'Especificações e Orcamentos I', 'Segurança do Trabalho', 'Técnicas Construtivas II', 'Estruturas de Concreto I', 'Mecânica dos Solos', 'Estruturas Metálicas', 'Estruturas de Madeira', 'Especificações e Orcamentos II', 'Planej. Gestão e Controle de Obra', 'Avaliação Pós-ocupação', 'Patologia das Construções', 'Manutenção Predial', 'Fundações e Sistemas de Contenção', 'Estruturas de Concreto II', 'Gestão da Qualidade e Produtividade']
        fisica = ['Introdução à Física', 'Pré-Cálculo', 'Psicologia da Aprendizagem', 'Álgebra Vetorial e Geometria Analítica', 'Língua Portuguesa I', 'Metodologia do Trabalho Científico', 'História da Educação', 'Inglês Instrumental', 'Filosofia da Educação', 'Química Geral', 'Sociologia da Educação', 'Educação em Direitos Humanos', 'Educação Ambiental e Sustentabilidade', 'Didática Geral', 'Políticas e Gestão Educacional', 'Prática de Ensino I', 'Física Moderna', 'Educação em Diversidade', 'Optativa I', 'Optativa II', 'Física Básica I', 'Física Experimental I', 'Cálculo Diferencial e Integral I', 'Álgebra Linear', 'Língua Portuguesa II', 'Didática Aplicada ao Ensino de Física', 'Prática de Ensino II', 'Mecânica Quântica', 'Libras', 'Física Básica II', 'Física Experimental II', 'Cálculo Diferencial e Integral II', 'Cálculo Diferencial e Integral III', 'Estágio Supervisionado I', 'Prática de Ensino III', 'TCC', 'Física Básica III', 'Física Experimental III', 'Computação Aplicada à Física', 'Física Matemática I', 'Termodinâmica', 'Estágio Supervisionado II', 'Prática de Lab. e Inst. para o Ens. de Fís. I', 'Prática de Ensino IV', 'Física Básica IV', 'Física Experimental IV', 'Mecânica Analítica', 'Eletromagnetismo', 'Estágio Supervisionado III', 'Prática de Lab. e Inst. para o Ens. de Fís. II', 'Mecânica Estatística', 'Física Moderna Experimental', 'Evolução do Pensamento Científico', 'Estágio Supervisionado IV']
        matematica = ['Matemática para o Ensino Médio 1', 'Matemática para o Ensino Fundamental', 'Trigonometria', 'História da Educação', 'Psicologia da Aprendizagem', 'Língua Portuguesa 1', 'Inglês Instrumental', 'Álgebra Vetorial e Geometria Analítica', 'Epistemologia da Matemática', 'Filosofia da Educação', 'Educação em Diversidade', 'Sociologia da Educação', 'Didática Geral', 'Metodologia do Trabalho Científico', 'Gestão Educacional e Planejamento', 'Educação em Direitos Humanos', 'Optativa 1', 'Educação Ambiental e Sustentabilidade', 'Optativa 2', 'Matemática para o Ensino Médio 2', 'Cálculo 1', 'Língua Portuguesa 2', 'Argumentação Matemática', 'Prática de Laboratório de Ensino de Matemática 1', 'Didática da Matemática', 'Libras 1', 'Desenho Geométrico', 'Pesquisa Aplicada em Matemática 1', 'Matemática para o Ensino Médio 3', 'Cálculo 2', 'Álgebra Linear 1', 'Prática de Laboratório de Ensino de Matemática 2', 'Introdução a Teoria dos Números', 'Geometria Euclidiana Plana', 'Matemática Financeira 1', 'Pesquisa Aplicada em Matemática 2', 'Cálculo 3', 'Física Básica 1', 'Prática de Ensino de Matemática 1', 'Introdução à Programação', 'Estágio Supervisionado 1', 'Estruturas Algébricas 1', 'Estatística e Probabilidade', 'Geometria Euclidiana Espacial', 'TCC', 'História da Matemática', 'Prática de Ensino de Matemática 2', 'Estágio Supervisionado 2', 'Análise Real 1', 'Equações Diferenciais Ordinárias', 'Prática de Ensino de Matemática 3', 'Estágio Supervisionado 3', 'Prática de Ensino de Matemática 4', 'Estágio Supervisionado 4']
        telematica = ['Introdução à Telemática', 'Fundamentos de Eletricidade', 'Programação I', 'Lab. de Sist. Abertos', 'Inglês Instrumental', 'Pré-cálculo', 'Língua Portuguesa', 'Arquitetura de Computadores', 'Educação em Diversidade', 'Metodologia da Pesquisa Científica', 'Educação Ambiental e Sustentabilidade', 'Formação do Empreendedor', 'Optativa I', 'Educação em Direitos Humanos', 'Relações Humanas no Trabalho', 'Ética', 'Optativa II', 'Redes de Computadores', 'Eletrônica para Telecomunicações', 'Medição Eletroeletrônica', 'Programação II', 'Cálculo Diferencial e Integral', 'Administração de Sistemas', 'Sistemas Operacionais', 'Tecnologias de Redes Locais', 'Estatística Aplicada à Telemática', 'Sinais e Sistemas', 'Programação III', 'Administração de Serviços', 'Interconexão de Redes', 'Cabeamento Estruturado', 'Teoria da Informação e Codificação', 'Sistemas de Comunicações', 'Processamento Digital de Sinais', 'Redes de Longa Distância', 'Segurança de Redes de Computadores', 'Comunicações Sem Fio', 'Comunicações Ópticas', 'Projeto em Telemática', 'Estágio Supervisionado (Optativa)', 'Projeto de Redes de Computadores', 'Sistemas Telefônicos', 'Trabalho de Conclusão de Curso (Obrigatória)']
        self.assertEqual(self.eng_comp.khan(), engenharia_computacao)
        self.assertEqual(self.letras.khan(), letras)
        self.assertEqual(self.const_edificios.khan(), construcao_edf)
        self.assertEqual(self.fisica.khan(), fisica)
        self.assertEqual(self.matematica.khan(), matematica)
        self.assertEqual(self.telematica.khan(), telematica)
        pass